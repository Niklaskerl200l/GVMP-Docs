...
function Besprechung_Archivieren()
{
  if(SpreadsheetApp.getActive().getSheetName() != "Besprechungsprotokoll Vorlage")
  {
    ...
    var SS_Export = SpreadsheetApp.openById(LSPD.ID_Archiv_GTF_Besprechungen);
...
function Besprechung_Anwesenheit(e)
{
  ...
  if(Spalte == Spalte_in_Index("C") && Zeile >= 6 && Zeile <= 11 && Value == "TRUE" || Spalte == Spalte_in_Index("E") && Zeile >= 6 && Zeile <= 11 && Value == "TRUE")
  { 
