...
function Eintrag_Check(Array_Eingabe, Off_Name, Off_Fraktion, Off_Aktivitaet, Off_Beamter, UI = false, Log_Stufe = "Information")
{
  try
  {
    if(Array_Eingabe[0][0].length > 1)  // Check ob 3D Array oder 2D Array
    {
      Array_Eingabe = Array_Eingabe[0];
    }

    if(Log_Stufe == "Information") Logger.log("Start Eintrag Check für:\n" + Array_Eingabe);

    if(Off_Name != -1) var Name = Array_Eingabe[Off_Name].toString();

    if(Off_Fraktion != -1) var Fraktion = Array_Eingabe[Off_Fraktion];

    if(Off_Aktivitaet != -1) var Aktivitaet = Array_Eingabe[Off_Aktivitaet];
    
    if(Off_Beamter != -1) var Beamter = Array_Eingabe[Off_Beamter];
    ...
    if(Off_Name != -1)
    {
      ...
      {
        if(Log_Stufe == "Warning") Logger.log("Fehler bei Eintrag Check für:\n" + Array_Eingabe);
        if(Log_Stufe == "Warning" || Log_Stufe == "Information") Logger.log("Name ist Leer");
    ...
    if(Off_Fraktion != -1)
    {
      ...
      {
        if(Log_Stufe == "Warning") Logger.log("Fehler bei Eintrag Check für:\n" + Array_Eingabe);
        if(Log_Stufe == "Warning" || Log_Stufe == "Information") Logger.log("Fraktion ist Leer");
    ...
    if(Off_Aktivitaet != -1)
    {
      ...
      {
        if(Log_Stufe == "Warning") Logger.log("Fehler bei Eintrag Check für:\n" + Array_Eingabe);
        if(Log_Stufe == "Warning" || Log_Stufe == "Information") Logger.log("Aktivität ist Leer");
    ...
    if(Off_Beamter != -1)
    {
      ...
      {
        if(Log_Stufe == "Warning") Logger.log("Fehler bei Eintrag Check für:\n" + Array_Eingabe);
        if(Log_Stufe == "Warning" || Log_Stufe == "Information") Logger.log("Beamter ist Leer");
    ...
    if(Off_Name != -1)
    {
      ...
      {
        if(Log_Stufe == "Warning") Logger.log("Fehler bei Eintrag Check für:\n" + Array_Eingabe);
        if(Log_Stufe == "Warning" || Log_Stufe == "Information") Logger.log("Name hat keinen Unterstrich " + Name);
      ...
      {
        if(Log_Stufe == "Warning") Logger.log("Fehler bei Eintrag Check für:\n" + Array_Eingabe);
        if(Log_Stufe == "Warning" || Log_Stufe == "Information") Logger.log("Name mit Leerzeichen");
      ...
      Array_Eingabe[Off_Name] = Name;
    }

    if(Log_Stufe == "Information") Logger.log("Check bestanden Ausgabe:\n" + Array_Eingabe);

    return Array_Eingabe;
  }
  catch(err)
  {
    if(Log_Stufe == "Error" || Log_Stufe == "Warning") Logger.log("Fehler bei Eintrag Check für:\n" + Array_Eingabe);
    if(Log_Stufe == "Error" || Log_Stufe == "Warning" || Log_Stufe == "Information") Logger.log(err.stack);
