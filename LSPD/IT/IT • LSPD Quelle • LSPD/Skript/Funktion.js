...
function Design_LSPD_Dark()   // Niklas_Kerl®
{
  ...
  .setConcreteColor(Themes.BACKGROUND,Color.setRgbColor("#886a41"))
  ...
  .setConcreteColor(Themes.ACCENT5,Color.setRgbColor("#6b312f"))
  .setConcreteColor(Themes.ACCENT6,Color.setRgbColor("#2e7246"))
  .setConcreteColor(Themes.HYPERLINK,Color.setRgbColor("#00ffff"));
