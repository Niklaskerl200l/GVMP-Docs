function Blitzermarathon(e) 
{
  var Sheet_Blitzermarathon = SpreadsheetApp.getActive().getSheetByName("Blitzermarathon Vorlage");
  ...
  {
    var Array_Streifen = Sheet_Blitzermarathon.getRange("V5:W" + Sheet_Blitzermarathon.getLastRow()).getValues();
    var Array_Messstellen = Sheet_Blitzermarathon.getRange("R6:S17").getValues();
