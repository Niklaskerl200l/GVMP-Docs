...
function Academy_Datum()   //Ausgabe Academy Termine für Acedemy Benutzerinterface
{
  ...
  Array.push(["Keine Academy notwendig"]);
...
function Academy_Eintragen(Datum = "07.04.2022",Bewerber = "TestH")    //Erstellen und eintragen in Academy
{
  ...
  if(Datum != "Keine Academy notwendig")
  {
    if(SS.getSheetByName("Academy " + Datum) == null)
    {
      ...
      "values": [["=SORT(FILTER({{IFERROR(INDIRECT(\"Academy \" & TEXT('Auswertungsgedöns'!L15 - 7;\"dd.MM.yyyy\") & \"!F5:F\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L15 & \"!F5:F\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L16 & \"!F5:F\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L17 & \"!F5:F\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L18 & \"!F5:F\");\"\")} \\ {IFERROR(INDIRECT(\"Academy \" & TEXT('Auswertungsgedöns'!L15 - 7;\"dd.MM.yyyy\") & \"!E5:E\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L15 & \"!E5:E\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L16 & \"!E5:E\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L17 & \"!E5:E\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L18 & \"!E5:E\");\"\")} \\ {IFERROR(INDIRECT(\"Academy \" & TEXT('Auswertungsgedöns'!L15 - 7;\"dd.MM.yyyy\") & \"!O5:O\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L15 & \"!O5:O\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L16 & \"!O5:O\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L17 & \"!O5:O\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L18 & \"!O5:O\");\"\")} \\ {IFERROR(INDIRECT(\"Academy \" & TEXT('Auswertungsgedöns'!L15 - 7;\"dd.MM.yyyy\") & \"!N5:N\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L15 & \"!N5:N\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L16 & \"!N5:N\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L17 & \"!N5:N\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L18 & \"!N5:N\");\"\")}}; {IFERROR(INDIRECT(\"Academy \" & TEXT('Auswertungsgedöns'!L15 - 7;\"dd.MM.yyyy\") & \"!F5:F\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L15 & \"!F5:F\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L16 & \"!F5:F\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L17 & \"!F5:F\");\"\") ; IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L18 & \"!F5:F\");\"\")} <> \"\";{IFERROR(INDIRECT(\"Academy \" & TEXT('Auswertungsgedöns'!L15 - 7;\"dd.MM.yyyy\") & \"!G5:G\");\"\");IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L15 & \"!G5:G\");\"\");IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L16 & \"!G5:G\");\"\");IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L17 & \"!G5:G\");\"\");IFERROR(INDIRECT(\"Academy \" & 'Auswertungsgedöns'!L18 & \"!G5:G\");\"\")} = TRUE);1;TRUE)"]]},"1dwowG4PVZZNdllgZtKDbG9i9Qr-wrw4qdrE3e-_VkPs","Export Bewerber!D2",{"valueInputOption": "USER_ENTERED"})
      }
  ...
  try
  {
    ...
    Sheet_LSMC.getRange("B" + Sheet_LSMC.getRange("B3").getValue()).setValue(Bewerber);
  }
  catch(err)
  {
