...
function Set_Bewertung(Bewerber,Bemerkung)
{
  ...
  for(var x = 0; x < Array_Bewerber[0].length; x++)
  {
    if(Array_Bewerber[0][x] == Bewerber)
    {
      ...
      Sheet_Bewerbungen.getRange(Letzte_Zeile,x + 5,1,3).setValues([[new Date(), Bemerkung, LSPD.Umwandeln()]]);
...
{
  var Sheet_Archiv = SpreadsheetApp.openById(LSPD.ID_Leitung_Training).getSheetByName("Bewerber Archiv");
